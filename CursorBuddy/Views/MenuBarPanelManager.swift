...
final class PanelPinState: ObservableObject {
    ...
    static let didChangeNotification = Notification.Name("com.cursorbuddy.panelPinStateChanged")
...
class MenuBarPanelManager: ObservableObject {
    ...
    static let dismissPanelNotification = Notification.Name("com.cursorbuddy.dismissPanel")
    static let resizePanelNotification = Notification.Name("com.cursorbuddy.resizePanel")
    ...
    /// Re-show the panel (e.g. after settings window closes).
    func restorePanel() {
    ...
    private static func makeMenuBarIcon() -> NSImage {
        ...
        if let sfImage = NSImage(systemSymbolName: symbolName, accessibilityDescription: "CursorBuddy") {
